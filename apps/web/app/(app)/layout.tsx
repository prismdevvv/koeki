...
function allowedNav(session: SessionInfo): string[] {
  ...
  if (hasPermission(session, "ninjas:write")) base.push("/zenkai");
  if (hasPermission(session, "payments:write") || hasPermission(session, "audit:read")) base.push("/recouvrement", "/actifs", "/inventory", "/equipement", "/statistics");
