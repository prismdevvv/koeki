  ...
  const catalogueTab = <>
    ...
    <section className="panel stack-panel">
      <SectionHeader title="Catalogue et tarification" description="Prix publics historisés, points et exonération gagnés par unité donnée, disponibilité du village."
        action={<>{canWrite && <Link className="button button-primary" href="/resources/transaction">Nouvelle transaction</Link>}{canManage && <Link className="text-link" href="/resources/new">Nouvelle ressource <ArrowRight size={15} /></Link>}</>} />
